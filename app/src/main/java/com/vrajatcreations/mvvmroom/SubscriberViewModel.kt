...
class SubscriberViewModel(private val repository: SubscriberRepository) : ViewModel(), Observable {
    ...
    private fun insert(subscriber: Subscriber) = viewModelScope.launch {
        ...
        if (newRowId > -1) {
            ...
            statusMessage.value = Event("Error Occured While Inserting!")
        }
    }
    ...
    private fun delete(subscriber: Subscriber) = viewModelScope.launch {
        ...
        if (noOfRowsDeleted > 0) {
            ...
            statusMessage.value = Event("Error in Deleting a Subscriber")
        }
    }
    ...
    private fun deleteAll() = viewModelScope.launch {
        ...
        if (noOfRowsDeleted >= 0) {
            ...
            statusMessage.value = Event("Error in Deleting a Subscribers")
        }
    }
    ...
    private fun setNullAndDefaultValues() {
        inputName.value = null
        inputEmail.value = null
